...
<header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 py-5 flex items-center justify-between {isScrolled ? 'bg-[#F9F8F6]/90 backdrop-blur-md shadow-sm' : 'bg-transparent'}">
  <div class="flex items-center">
    ...
    <a href="/" class="flex items-center gap-2 group">
      <svg width="28" height="28" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="font-bold text-xl tracking-wide text-[#1A1A1A]">Vani</span>
    </a>
  </div>
  ...
  <div class="flex items-center gap-8">
    ...
    <a href="#waitlist" class="bg-[#1A1A1A] text-white text-[13px] font-medium px-5 py-2.5 rounded-sm hover:bg-black transition-colors">
      Join Waitlist
    </a>
  </div>
</header>